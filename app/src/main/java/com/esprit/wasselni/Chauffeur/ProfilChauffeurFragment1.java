...
public class ProfilChauffeurFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.content_fragment_modifier_chauffeur1,container,false);
        ...
        _nameText.setText(Chauffeur.nom);
        _lastnameText.setText(Chauffeur.prenom);
        _numTelText.setText(Chauffeur.telephone);
        _numPermis.setText(Chauffeur.id);
        ...
        _nextSignupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new ProfilChauffeurFragment2();
